                  ...
                  AnimatedRadialGauge(
                    ...
                    builder: (context, child, value) => RadialGaugeLabel(
                      ...
                      style: TextStyle(
                        color: Colors.black,
                        fontSize:
                            width / context.responsive(xs: 25, md: 40, lg: 20),
                    ...
                    axis: GaugeAxis(
                      ...
                      style: GaugeAxisStyle(
                        thickness: width /
                            context.responsive(xs: 20, sm: 25, md: 40, lg: 30),
                      ...
                      pointer: GaugePointer.triangle(
                        width: width /
                            context.responsive(xs: 40, sm: 50, md: 80, lg: 60),
                        height:
                            height / context.responsive(xs: 20, md: 18, lg: 10),
